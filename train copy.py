...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.PROMETAR.ADAPT_LR = 1.0
    ...
    cfg.OPTIM_VNET.LR = 0.1
    cfg.OPTIM_VNET.WEIGHT_DECAY = 5e-1
    ...
    cfg.OPTIM_VNET.MAX_EPOCH = 8
    # Set WARMUP_EPOCH larger than 0 to activate warmup training
    cfg.OPTIM_VNET.WARMUP_EPOCH = -1
    # Either linear or constant
    cfg.OPTIM_VNET.WARMUP_TYPE = "linear"
    # Constant learning rate when type=constant
    cfg.OPTIM_VNET.WARMUP_CONS_LR = 1e-1
    # Minimum learning rate when type=linear
    cfg.OPTIM_VNET.WARMUP_MIN_LR = 1e-1
...
if __name__ == "__main__":
    ...
    parser.add_argument("--trainer", type=str, default="ProMetaR", help="name of trainer")
