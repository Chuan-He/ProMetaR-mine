...
class VNet(nn.Module):
    ...
    def forward(self, gradients1, gradients2, gradients3, param_name):
        ...
        if gradients2 == None:
            ...
            a_grad = gradients1.clone()
            b_grad = gradients3.clone()
...
class ProMetaR(TrainerX):
    ...
    def forward_backward(self, batch):
        ...
        logits_ce, rag_text, rag_image = model(image)
        ...
        # adaptation_logits_ce, adaptation_rag_text, adaptation_rag_image = task_model(image)
        # adaptation_loss_ce = F.cross_entropy(adaptation_logits_ce, label)
        ...
        # query_logits_ce, query_rag_text, query_rag_image= task_model(image2)
        # query_loss = F.cross_entropy(query_logits_ce, label)
