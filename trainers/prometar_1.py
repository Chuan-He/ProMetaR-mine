...
class CustomCLIP(nn.Module):
    ...
    def forward(self, image, label_idx=None):
        ...
        reg_image = F.l1_loss(image_features, image_features_zs,
                                    reduction='mean')
        logits = (logits_i + logits_t + logits_ce) / 3
...
class ProMetaR(TrainerX):
    ...
    def forward_backward(self, batch):
        ...
        loss_ce = F.cross_entropy(logits_ce, label) + reg_text + reg_image
        ...
        while (len(total_losses) == 0 and t < 5):
            t = t + 1
            task_loss = []
